...
- System Edge smoke tests passed: AI settings panel opens, provider/model/key controls render, no-key status is clear, console errors are empty, and a mocked Google Gemini response drove an AI play-phase decision through the real rules engine.
- Latest update:
